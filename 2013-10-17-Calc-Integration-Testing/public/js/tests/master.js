...
test('alternating background color', function(){
  ...
  $('#history > li').length, 2, 'should be 2 results');


  ok($('#history > li:first-child > span:last-child').hasClass('remove'), 'should have remove class for last span');
  ok($('#history > li:nth-child(2n+3)').css('background', '#ccc'), 'background changes every odd');
});
